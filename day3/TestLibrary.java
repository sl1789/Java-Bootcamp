...
public class TestLibrary {
	...
	public static void main(String[] args) {
		...
		libraryInface(theGuyWhoKnowsAlot);
	...
	public static void libraryInface(Librarian theGuyWhoKnowsAlot){
		...
		char val = scan1.next().charAt(0);
				
		switch(val){
		case '1': theGuyWhoKnowsAlot.findMeAvailableBooks();break;
		case '2': System.out.println("Please enter book title");
		//SOS thus do we clear the scanner
				scan1.nextLine();
				String title=scan1.nextLine();
				theGuyWhoKnowsAlot.findMeBook(title);
				break;
		case '3': System.out.println("Please enter author name");
				scan1.nextLine();
				String name=scan1.nextLine();
				theGuyWhoKnowsAlot.findMeBooksFromAuthor(name);
				break;
		case '4': theGuyWhoKnowsAlot.findMostPopularBook();break;
		case 'q':return;//this is how we quit out of the loop
		default:System.out.println("Wrong input. Please try again");
				libraryInface(theGuyWhoKnowsAlot);break;
		}
		}
		}
